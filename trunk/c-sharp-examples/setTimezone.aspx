...
HttpWebRequest oReqTimezone = (HttpWebRequest)System.Net.WebRequest.Create(sEndpoint + "setTimezone.aspx?Timezone=" + sTimezone);
...
Response.Write("setTimezone result: " + sRespTimezone + "<br />");  //do something more elegant here
