...
HttpWebRequest oReqSession = (HttpWebRequest)System.Net.WebRequest.Create(sEndpoint + "getSession.aspx?node=" + sNode);
...
Response.Write("getSession result: " + sRespSession + "<br />");  //do something more elegant here
