...
HttpWebRequest oReqChat = (HttpWebRequest)System.Net.WebRequest.Create(sEndpoint + "getChat.aspx?session=" + sSession);
...
Response.Write("getChat result: " + sRespChat + "<br />");  //do something more elegant here
