...
string sReportArea = "4";  //see https://secure.logmeinwiki.com/wiki/Rescue:API/setReportArea#HTTP_POST for all areas
HttpWebRequest oReqReportArea = (HttpWebRequest)System.Net.WebRequest.Create(sEndpoint + "setReportArea.aspx?area=" + sReportArea);
...
Response.Write("setReportArea result: " + sRespReportArea + "<br />");  //do something more elegant here
