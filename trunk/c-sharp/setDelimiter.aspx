...
string sDelimiter = "+";
HttpWebRequest oReqDelimiter = (HttpWebRequest)System.Net.WebRequest.Create(sEndpoint + "setDelimiter.aspx?delimiter=" + sDelimiter);
...
Response.Write("setDelimiter result: " + sRespDelimiter + "<br />");  //do something more elegant here
