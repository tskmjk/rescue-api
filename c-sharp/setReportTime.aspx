...
string sBTime = "10:00";
string sETime = "22:00";
HttpWebRequest oReqReportTime = (HttpWebRequest)System.Net.WebRequest.Create(sEndpoint + "setReportTime.aspx?btime=" + sBTime + "&etime=" + sETime);
...
Response.Write("setReportTime result: " + sRespReportTime + "<br />");  //do something more elegant here
