...
//get the Note info
string sSession = "6350757";  //populate this sessionID dynamically
HttpWebRequest oReqNote = (HttpWebRequest)System.Net.WebRequest.Create(sEndpoint + "getNote.aspx?session=" + sSession);
...
Response.Write("getNote result: " + sRespNote + "<br />");  //do something more elegant here
