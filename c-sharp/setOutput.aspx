...
//get the Output info
string sOutput = "XML";
HttpWebRequest oReqOutput = (HttpWebRequest)System.Net.WebRequest.Create(sEndpoint + "setOutput.aspx?output=" + sOutput);
...
Response.Write("setOutput result: " + sRespOutput + "<br />");  //do something more elegant here
