...
$iNodeID = "someNode";				//define this with your own data
$eNodeRef = "NODE or CHANNEL";			//define this appropraitely based on your data
...
//get session(s)
$sessionresult = $proxy->getSession($sessionparams);
